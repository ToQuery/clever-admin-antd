export default {
  ...
  'pages.commonTable.new': '新建',
  'pages.commonTable.update': '修改',
  'pages.commonTable.delete': '删除',
  'pages.commonTable.createDateTime': '创建时间',
  'pages.commonTable.updateDateTime': '修改时间',
  'pages.commonTable.confirm': '确认',
  'pages.commonTable.cancel': '取消',
  'pages.commonTable.option': '操作',
  'pages.commonTable.chosen': '已选择',
  'pages.commonTable.item': '项',
  'pages.commonTable.batchDelete': '批量删除',
  ...
  'pages.system.logTable.moduleName': '模块名称',
  'pages.system.logTable.bizName': '业务名称',
  'pages.system.logTable.logType': '日志类型',
  'pages.system.logTable.rawData': '原始数据',
  'pages.system.logTable.targetData': '变更数据',
  'pages.system.logTable.logType.create': '创建',
  'pages.system.logTable.logType.modify': '修改',
